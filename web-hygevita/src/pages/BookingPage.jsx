    ...
    <TenantProvider tenant={tenant}>
      <div className="min-h-screen bg-gray-50">
        ...
        <header
          ...
          style={{ backgroundColor: 'var(--color-tenant-primary, #0E9488)' }}
        >
          <div className="max-w-4xl mx-auto flex items-center justify-between">
            ...
            {tenant?.telefono && (
              <a href={`tel:${tenant.telefono}`} className="hidden sm:flex items-center gap-2 bg-white rounded-full px-5 py-2.5 text-sm font-semibold text-gray-800 hover:shadow-lg transition-all">
                <Phone className="w-4 h-4" style={{ color: 'var(--color-tenant-primary, #0E9488)' }} />
        ...
        >
          ...
          {tenant?.plan !== 'professional' && tenant?.plan !== 'enterprise' && (
            <p className="text-xs mt-2 text-gray-800/50">Powered by Hygevita</p>
          )}
        </footer>
      </div>
    </TenantProvider>
