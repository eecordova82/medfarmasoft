...
// Defaults del flavor Hygevita — se usan si la API no devuelve URLs específicas
const DEFAULTS = {
  androidUrl: 'https://play.google.com/store/apps/details?id=com.hygevita.app',
  iosUrl: 'https://apps.apple.com/app/hygevita/id000000000',
}

/**
 * Página de acceso para pacientes via deep link.
 * URL: https://hygevita.com/acceso/{tenantCodigo}
 *
...
export default function AccesoPage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      window.location.href = `hygevita://acceso/${tenant}`
    }, 500)
      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="mb-8">
          {loading ? (
            ...
            <div className="w-20 h-20 bg-[#0E9488] rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
              <span className="text-white text-3xl font-bold">
                {nombreTenant?.charAt(0)?.toUpperCase() || 'H'}
              </span>
            </div>
          )}
          <h1 className="text-2xl font-bold text-gray-800">{nombreTenant || 'Hygevita'}</h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-6">
          ...
          <p className="text-2xl font-bold text-[#0E9488] mb-6">
            {loading ? (
          ...
          <p className="text-gray-500 text-sm mb-6">
            Abre la app Hygevita en tu móvil para continuar.
          ...
          {loading ? (
            ...
            <div className="flex flex-col gap-3">
              ...
              <a
                href={androidUrl}
                className="flex items-center justify-center gap-3 bg-[#0E9488] text-white rounded-xl py-3 px-6 hover:bg-[#0A6B62] transition-colors"
              >
                <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
        ...
        <p className="text-xs text-gray-400">
          ...
          <a
            href={`hygevita://acceso/${tenant}`}
            className="text-[#0E9488] underline"
          >
            pulsa aquí
          </a>
        </p>
