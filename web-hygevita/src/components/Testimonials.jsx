...
const testimonials = [
  {
    ...
    text: 'Hygevita ha transformado la gestión de nuestra clínica. El historial clínico digital y la gestión de citas nos han permitido atender a más pacientes con mayor eficiencia.',
    rating: 5,
    initials: 'MG',
    color: 'bg-primary',
  },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 reveal">
          ...
          <p className="text-lg text-neutral-text">
            Clínicas y farmacias que ya confían en Hygevita para su gestión diaria.
          </p>
        </div>
