      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <a href="/" className="inline-flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-secondary">MedFarmaSoft</span>
          </a>
        </div>
          ...
          {status === 'invalid' && (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-400">
                Para suscribirte, abre la aplicación MedFarmaSoft y selecciona un plan desde la sección de suscripción.
              </p>
            </div>
          )}
