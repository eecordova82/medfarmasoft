...
const plans = [
  {
    ...
    features: [
      ...
      { text: 'Medicación y dispensaciones', included: true },
      { text: 'Recordatorios por email', included: true },
      { text: 'Consentimientos RGPD + PDF', included: true },
      { text: 'Notas por voz en consultas', included: true },
      { text: 'Auditoría de acciones', included: true },
      { text: 'Sync Google/Outlook', included: false },
      { text: 'Dosificación y recordatorios', included: false },
      { text: 'Recordatorios WhatsApp', included: false },
      { text: 'Informes y estadísticas', included: false },
    ],
    cta: 'Empezar gratis',
    highlighted: false,
  },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Historial clínico completo', included: true },
      { text: 'Medicación y dispensaciones', included: true },
      { text: 'Recordatorios email + WhatsApp', included: true },
      { text: 'Consentimientos RGPD + PDF', included: true },
      { text: 'Notas por voz en consultas', included: true },
      { text: 'Sync Google Calendar y Outlook', included: true },
      { text: 'Dosificación y adherencia', included: true },
      { text: 'Informes y estadísticas', included: true },
      { text: 'Auditoría completa', included: true },
      { text: 'InBody integration', included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Sync Google Calendar y Outlook', included: true },
      { text: 'InBody integration', included: true },
      ...
      { text: 'Auditoría y logs de errores', included: true },
